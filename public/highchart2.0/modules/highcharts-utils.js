...
function build_clusteredbar_ms(container_id) {
    ...
    Highcharts.chart(container_id, {
        ...
        xAxis: {
            categories: ['Akwa Ibom', 'Benue', 'Gombe', 'Imo', 'Kaduna', 'Kano', 'Lagos'],
            title: {
                text: null
            }
        },
        ...
        series: [{
            name: 'Number of deceased reported',
            data: [201, 382, 70, 129, 111, 159, 92],
            color: '#CCCCFF'
        }, {
            name: 'VA interview conducted',
             data: [23, 5, 8, 17, 3, 0, 3],
             color: '#FA5F55'
        }, {
            name: 'Cause of death output',
            data: [0, 0, 0, 17, 0, 0, 0],
            color: '#FFBF00'
        }]
...
function build_donut_ms(container_id, seriesData) {
...
function build_neg_msbar_chart(container_id) {
    var categories = [
        '0-4', '5-9', '10-14', '15-19',
...
function build_neg_msbar_chart2(container_id) {
...
function plotMapMs(container_id) {
    var data = [
        ['ng-ri', 0],
        ['ng-kt', 1],
        ['ng-so', 2],
    ...
    // Create the chart
    Highcharts.mapChart(container_id, {
        chart: {
...
function build_stackedMs_chart(container_id) {
    Highcharts.chart(container_id, {
        chart: {
            type: 'column'
        },
        ...
        yAxis: {
            min: 0,
            title: {
                text: 'Quarterly Disaggregation of PLHIV Deaths'
            }
        },
        legend: {
            reversed: true
        ...
        series: [{
            ...
            name: 'Children 5-18 Years',
            data: [3, 4, 2, 5],
            color: '#794541'
        }, {
            name: 'Children 1 Month - 4 Years',
            data: [2, 2, 2, 1],
            color: '#65562A'
        }, {
            name: '0-27 days',
...
function build_nomisbar(container_id, xaxisCategory, seriesData) {
...
function plotMapOvc(container_id, data) {
    //var data = [
    ...
    Highcharts.mapChart(container_id, {
        ...
        //colors: ['#145A32', '#98ac46', '#f3bd09', '#f60b29', '#FFA500'],
        ...
        series: [{
            name: 'Countries',
            //nullColors: ['#145A32', '#98ac46', '#f3bd09', '#f60b29','#FFA500'],
            enableMouseTracking: false
        }, {
            data: data,
            name: 'CDC OVC STATES',
...
function build_nomisdonut (container_id, seriesData, textdata) {
...
function build_neg_ovcbar_chart(container_id, xaxisCategories, seriesData) {
    var categories = xaxisCategories;
